...
cid = f.getvalue('t1')
cname = f.getvalue('t2')
duration = f.getvalue('t3')
discription = f.getvalue('t4')
...
try:
    ...
    values = (cid ,cname, duration, discription)

    cursor.execute(query, values)
    conn.commit()

    print("<html><body><h2>Data Inserted Successfully into Course!</h2></body></html>")
